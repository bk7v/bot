...
.setThumbnail(message.author.avatarURL)    
      ...
      .addField("**%bc  :mega:**","**لـ ظهار حميع برودكاست**")
...
if (message.content === '%bc') {
         let embed = new Discord.RichEmbed()
.setThumbnail(message.author.avatarURL)  
      .addField("**:radioactive: أوامر برودكاست**","** **")
      .addField("**%bc1  :mega:**","** ❖لـ برودكاست للكل امبد**")
      .addField("**%bc2  :mega:**","** ❖لـ برودكاست للأونلاين مع منشن بدون امبد **")
      .addField("**%bc3  :mega:**","** ❖لـ ❖ برودكاست  كرساله بدون اي شئ ..**")
      .addField("**%bc4  :mega:**","** ❖لـ برودكاست + للكل + مع منشن + بدون امبد  ..**")
.setColor('RANDOM')
 message.author.sendEmbed(embed);
    }
}); 
...
if (message.content === '%owner') {
         let embed = new Discord.RichEmbed()
.setThumbnail(message.author.avatarURL)    
      .addField("**تم تطوير وبرمجه البوت من قبل :wrench: **","** Oh , '♕bk7-v#5107**")
.setColor('#B101FC')
  message.author.sendEmbed(embed);
    }
});
...
client.on('message', message => {
              if(!message.channel.guild) return;
    var prefix = "%";
    if(message.content.startsWith(prefix + 'bc5')) {
